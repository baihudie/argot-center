...
@Component
public class TcpStep3Handler extends PipeHandlerDispatcher {


    public PipeBodyAuto genPipeBodyAuto(Channel channel, String pseudonym, int reqType, String body) {

        TcpStep3Body.TcpStep3ReqBody reqBody = JSON.parseObject(body, TcpStep3Body.TcpStep3ReqBody.class);
        ...
        synchronized (connSwitchEntity) {
            ...
            String aRemoteIp = remoteAddress.getAddress().getHostAddress();
            int aRemotePort = remoteAddress.getPort();
            connSwitchEntity.setARemoteIp(aRemoteIp);
            connSwitchEntity.setARemotePort(aRemotePort);

            int tcp4 = connSwitchEntity.getTcp4();
            if (tcp4 == ConnSwitchEntity.OK) {

                String bRemoteIp = connSwitchEntity.getBRemoteIp();
                int bRemotePort = connSwitchEntity.getBRemotePort();
                ...
                connSwitchEntity.setTcp3(ConnSwitchEntity.OK);
            }
        }
